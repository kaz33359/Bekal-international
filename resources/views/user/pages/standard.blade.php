...
@section('pagetitle' , 'Standard Non AC room')
...
<!-- Room Page Slider -->
    <header class="header slider">
        <div class="owl-carousel owl-theme">
            ...
            <div class="text-center item bg-img" data-overlay-dark="3" data-background="{{ asset('user/assets/img/slider/standard/1.JPG') }}"></div>
            <div class="text-center item bg-img" data-overlay-dark="3" data-background="{{ asset('user/assets/img/slider/standard/2.JPG')}}"></div>
            <!-- <div class="text-center item bg-img" data-overlay-dark="3" data-background="assets/img/slider/5.jpg"></div> -->
        </div>
        <!-- arrow down -->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12"> 
                    ...
                    <div class="section-title">Standard Non AC Room</div>
                </div>
                <div class="col-md-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <br>Shampoo <br>Shower <br>Toilet <br>Towel</p>
                        </div>
                        <div class="col-md-6">
                            <h6 style="margin-bottom: 10px;">General</h6>
                            <p style="margin-bottom: 30px;">No Smoking <br>Fan <br>Key card access <br>Trash cans</p>
                        </div>
