...
@section('pagetitle' , 'Superior AC Room')
...
<!-- Room Page Slider -->
    <header class="header slider">
        <div class="owl-carousel owl-theme">
            ...
            <div class="text-center item bg-img" data-overlay-dark="3" data-background="{{ asset('user/assets/img/slider/ac/4.JPG') }}"></div>
            <div class="text-center item bg-img" data-overlay-dark="3" data-background="{{ asset('user/assets/img/slider/ac/1.JPG') }}"></div>
            <div class="text-center item bg-img" data-overlay-dark="3" data-background="{{ asset('user/assets/img/slider/ac/2.JPG') }}"></div>
            <div class="text-center item bg-img" data-overlay-dark="3" data-background="{{ asset('user/assets/img/slider/ac/3.JPG') }}"></div>
        </div>
        <!-- arrow down -->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12"> 
                    ...
                    <div class="section-title">Superior AC Room</div>
                </div>
                <div class="col-md-8">
                     <p class="mb-30">This double room features a cable TV and air conditioning.</p>
                    <div class="row">
                        <div class="col-md-6">
                            <h6>Check-in</h6>
                        ...
                        <div class="col-md-6">
                            ...
                            <p style="margin-bottom: 30px;">Bottle of water</p>
                        </div>
                        
                        <div class="col-md-6">
                            <h6 style="margin-bottom: 10px;">Bathroom</h6>
                            <p style="margin-bottom: 30px;">Bidet <br>Body Soap <br>Free Toiletries <br>Private Bathroom
                            <br>Shampoo <br>Shower <br>Toilet <br>Toothbrush <br>Towels</p>
                        </div>
                        <div class="col-md-6">
                            <h6 style="margin-bottom: 10px;">General</h6>
                            <p style="margin-bottom: 30px;">No Smoking <br>Air conditioning <br>Fan <br>Key card access <br>Trash cans</p>
                        </div>
