...
@section('pagetitle' , 'Executive Twin Room')
...
<!-- Room Page Slider -->
    <header class="header slider">
        <div class="owl-carousel owl-theme">
            ...
            <div class="text-center item bg-img" data-overlay-dark="3" data-background="{{ asset('user/assets/img/slider/etwin/2.JPG') }}"></div>
            <div class="text-center item bg-img" data-overlay-dark="3" data-background="{{ asset('user/assets/img/slider/etwin/1.JPG') }}"></div>
            <div class="text-center item bg-img" data-overlay-dark="3" data-background="{{ asset('user/assets/img/slider/etwin/3.JPG') }}"></div>
        </div>
        <!-- arrow down -->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12"> 
                    ...
                    <div class="section-title">Executive Twin Room</div>
                </div>
                <div class="col-md-8">
                    <p class="mb-30">This twin room has a balcony, cable TV and air conditioning.</p>
                    <div class="row">
                        <div class="col-md-6">
                            <h6>Check-in</h6>
                        ...
                        <div class="col-md-6">
                            ...
                            <p style="margin-bottom: 30px;">Electric kettle </p>
                        </div>
