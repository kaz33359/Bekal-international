...
@section('pagetitle' , 'Executive King Room')
...
<!-- Room Page Slider -->
    <header class="header slider">
        <div class="owl-carousel owl-theme">
            ...
            <div class="text-center item bg-img" data-overlay-dark="3" data-background="{{ asset('user/assets/img/slider/eking/5.JPG') }}"></div>
            <div class="text-center item bg-img" data-overlay-dark="3" data-background="{{ asset('user/assets/img/slider/eking/6.JPG') }}"></div>
            <div class="text-center item bg-img" data-overlay-dark="3" data-background="{{ asset('user/assets/img/slider/eking/9.JPG') }}"></div>
        </div>{{ asset('user/') }}
        <!-- arrow down -->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12"> 
                    ...
                    <div class="section-title">Executive King Room</div>
                </div>
                <div class="col-md-8">
                    <p class="mb-30">This double room features an electric kettle, minibar and air conditioning.</p>
                    <div class="row">
                        <div class="col-md-6">
                            <h6>Check-in</h6>
                        ...
                        <div class="col-md-6">
                            ...
                            <p style="margin-bottom: 30px;">Bottle of water <br>Minibar <br>Tea/Coffee maker</p>
                        </div>
                        
                        <div class="col-md-6">
                            <h6 style="margin-bottom: 10px;">Bathroom</h6>
                            <p style="margin-bottom: 30px;">Bidet <br>Body Soap <br>conditioner <br>Free Toiletries <br>Private Bathroom
                            <br>Shampoo <br>Shower <br>Shower cap <br>Slippers <br>Toilet <br>Toothbrush <br>Towels</p>
                        </div>
                        <div class="col-md-6">
                            <h6 style="margin-bottom: 10px;">General</h6>
                            <p style="margin-bottom: 30px;">No Smoking <br>Air conditioning <br>Fan <br>Interconnected room(s) available <br>Key card access <br>Trash cans</p>
                        </div>

                        <div class="col-md-6">
                            <h6 style="margin-bottom: 10px;">Kitchen</h6>
                            <p style="margin-bottom: 30px;">Electric kettle <br>Refrigerator </p>
                        </div>
