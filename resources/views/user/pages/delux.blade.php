...
<!-- Room Page Slider -->
    <header class="header slider">
        <div class="owl-carousel owl-theme">
            ...
            <div class="text-center item bg-img" data-overlay-dark="3" data-background="{{ asset('user/assets/img/slider/delux/1.JPG') }}"></div>
            <div class="text-center item bg-img" data-overlay-dark="3" data-background="{{ asset('user/assets/img/slider/delux/2.JPG') }}"></div>
            <div class="text-center item bg-img" data-overlay-dark="3" data-background="{{ asset('user/assets/img/slider/delux/3.JPG') }}"></div>
        </div>
        <!-- arrow down -->
    ...
    <section class="rooms-page section-padding" data-scroll-index="1">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <p class="mb-30">This double room has a tea/coffee maker, flat-screen TV and electric kettle.</p>
                    <div class="row">
                        <div class="col-md-6">
                            <h6>Check-in</h6>
