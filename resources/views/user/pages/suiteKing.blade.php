...
@section('pagetitle' , 'Suite King Room')
...
<!-- Room Page Slider -->
    <header class="header slider">
        <div class="owl-carousel owl-theme">
            ...
            <div class="text-center item bg-img" data-overlay-dark="3" data-background="{{ asset('user/assets/img/slider/suiteking/1.JPG') }}"></div>
            <div class="text-center item bg-img" data-overlay-dark="3" data-background="{{ asset('user/assets/img/slider/suiteking/3.JPG') }}"></div>
            <div class="text-center item bg-img" data-overlay-dark="3" data-background="{{ asset('user/assets/img/slider/suiteking/6.JPG') }}"></div>
            <div class="text-center item bg-img" data-overlay-dark="3" data-background="{{ asset('user/assets/img/slider/suiteking/4.JPG') }}"></div>
        </div>
        <!-- arrow down -->
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12"> 
                    ...
                    <div class="section-title">Suite King Room</div>
                </div>
                <div class="col-md-8">
                    <p class="mb-30">This suite features a tea/coffee maker, sofa and tumble dryer.</p>
                    <div class="row">
                        <div class="col-md-6">
                            <h6>Check-in</h6>
                        ...
                        <div class="col-md-6">
                            <h6 style="margin-bottom: 10px;">Living Area</h6>
                            <p style="margin-bottom: 30px;">Sofa</p>
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <p style="margin-bottom: 30px;">Electric kettle <br>Refrigerator <br>Tumble dryer</p>
                        </div>
                ...
                <div class="col-md-3 offset-md-1">
                    ...
                    <ul class="list-unstyled page-list mb-30">
                        ...
                        <li>
                            <div class="page-list-icon"> <span class="ti-soundcloud"></span> </div>
                            <div class="page-list-text">
                                <p>Sofa bed</p>
                            </div>
                        </li>
